...
def save_product_before_delete(sender, instance, **kwargs):
    file_path = os.path.join(BASE_DIR, 'shop/delete', f'product_{instance.id}_backup.json')
    product_data = {
        'id': instance.id,
        'name': instance.name,
    }
...
def save_category_before_delete(sender, instance, **kwargs):
    file_path = os.path.join(BASE_DIR, 'shop/delete', f'category_{instance.id}_backup.json')
    category_data = {
        'id': instance.id,
        'name': instance.name,
        'slug': instance.slug
